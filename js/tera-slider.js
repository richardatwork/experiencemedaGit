    ...
    $slider.mousemove(function(e){ // Get the cursor position
        ...
        if($sldr.hasClass('multi-slides')){
            ...
            if($mousePos.x > $sldr.width()/2) {
              $sldr.find('.slides').css('cursor', 'url(js/slide-right-dark.png) 5 -25, e-resize');
              if($('body').hasClass('dark-hero'))
                $sldr.find('.slides').css('cursor', 'url(js/slide-right.png) 5 -25, e-resize');
            } else {
              $sldr.find('.slides').css('cursor', 'url(js/slide-left-dark.png) 5 -25, w-resize');
              if($('body').hasClass('dark-hero'))
                $sldr.find('.slides').css('cursor', 'url(js/slide-left.png) 5 -25, w-resize');
            }
